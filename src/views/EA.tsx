  ...
  return (
    <Wrapper>
      ...
      <Foreground>
        ...
        <Subtitle>
          Temukan Expert Advisor terbaik untuk trading otomatis Anda. Setiap EA dirancang dengan strategi yang telah teruji untuk memberikan hasil optimal di berbagai kondisi pasar.
        </Subtitle>
        <SearchWrapper>
          <SearchInput
            type="text"
