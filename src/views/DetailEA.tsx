    ...
    <PageWrapper>
      ...
      <Container>
        <Breadcrumb>
          ...
          <span tw="mx-2">/</span>
          <BreadcrumbLink onClick={() => navigate('/EA')}>Expert Advisors</BreadcrumbLink>
          <span tw="mx-2">/</span>
          ...
          <InfoSection>
            ...
            <FeaturesList>
              <FeatureItem>
                ...
                <span>Advanced trading algorithm with proven results</span>
              </FeatureItem>
              <FeatureItem>
                <FeatureIcon>✓</FeatureIcon>
                <span>Built-in risk management system</span>
              </FeatureItem>
              <FeatureItem>
                <FeatureIcon>✓</FeatureIcon>
                <span>Compatible with MT4 and MT5 platforms</span>
              </FeatureItem>
              <FeatureItem>
                <FeatureIcon>✓</FeatureIcon>
              ...
              <FeatureItem>
                <FeatureIcon>✓</FeatureIcon>
                <span>Money-back guarantee (30 days)</span>
              </FeatureItem>
            </FeaturesList>
